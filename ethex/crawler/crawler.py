...
from ethex.crawler.util import initMongo, makeBlockQueue, decodeBlock, \
...
class Crawler(object):
    ...
    def __init__(
        ...
        self.mongo_client = initMongo(MongoClient())
